...
public class SqlInterventionUtil {

	private InterventionDto dto = createDefaultDto();

	public SqlInterventionUtil forWorkOrder(String wId) {
		dto.workOrderId = wId;
		return this;
	}

	public SqlInterventionUtil forMechanic(String mId) {
		dto.mechanicId = mId;
		return this;
	}

	public SqlInterventionUtil register() {
